...
- Source `pledgors.registry`
- Fields with path `pledge_pledgors.*`
...
- Consistency [json-schema.json](reports/default/json-schema.json) and [fields_list.json](fields/default/fields_list.json)
